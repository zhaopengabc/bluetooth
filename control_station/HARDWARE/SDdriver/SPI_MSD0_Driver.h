...
#define MSD0_card_enable()      	GPIOA->BRR = GPIO_Pin_15//GPIO_ResetBits(GPIOA,GPIO_Pin_4)
#define MSD0_card_disable()     	GPIOA->BSRR = GPIO_Pin_15//GPIO_SetBits(GPIOA,GPIO_Pin_4)
